...
class CacheDeploymentModeSettings(BaseSettings):
...
class CacheRedisCommonSettings(CacheDeploymentModeSettings):
...
class CacheRedisClusterSettings(CacheRedisCommonSettings):
...
class CacheRedisSettings(CacheRedisCommonSettings):
